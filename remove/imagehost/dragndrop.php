...
value="application/x-java-applet;version=1.5" />
    ...
    <param name="postURL"
value="<?php echo $CONFIG['httpPath']."/imagehost/dragndropupload.".URLPATH; ?>" />
    <param name="nbFilesPerRequest" value="4" />
    Java 1.5 or higher plugin required. 
        </applet>	
      </p>
    <p><a href="<?php echo $CONFIG['httpPath']."/imagehost/index.".URLPATH; ?>/cache/2/">View Your Files</a> </p></td>
  </tr>
</table>