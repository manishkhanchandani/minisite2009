...
$sql = "CREATE DATABASE IF NOT EXISTS `minisite09`";
@mysql_query($sql);
...
$sql = "drop table `blog_categories`";
@mysql_query($sql);
...
[[BODY]]
<hr>
footer', `css`='', `js`='', `siteurl`='http://10000projects.info/minisite/project2', `sitename`='Mumbai', `siteemail`='mumbai@mkgalaxy.com', `ftphost`='ftp.servage.net', `ftpuser`='manishkk', `ftppassword`='mAnIsH74', `ftpdir`='/www/minisite/project2', `dbhost`='mysql1076.servage.net', `db`='minisite09', `dbuser`='minisite09', `dbpassword`='password123'";
@mysql_query($sql);
...
[[BODY]]
<hr>
footer', `css`='', `js`='', `siteurl`='', `sitename`='', `siteemail`='', `ftphost`='', `ftpuser`='', `ftppassword`='', `ftpdir`='', `dbhost`='', `db`='', `dbuser`='', `dbpassword`=''";
@mysql_query($sql);
...
$sql = "insert into prebuilt_1 set `id`='4', `keyword`='Tomato', `template`='', `css`='', `js`='', `siteurl`='', `sitename`='', `siteemail`='', `ftphost`='', `ftpuser`='', `ftppassword`='', `ftpdir`='', `dbhost`='', `db`='', `dbuser`='', `dbpassword`=''";
@mysql_query($sql);

$sql = "drop table `prebuilt_2_concepts`";
@mysql_query($sql);
...
$sql = "drop table `prebuilt_3_settings`";
@mysql_query($sql);
...
$sql = "drop table `prebuilt_concepts`";
@mysql_query($sql);
...
$sql = "drop table `prebuilt_concepts_settings`";
@mysql_query($sql);
