...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO prebuilt_templates (name, template, css, js) VALUES (%s, %s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE prebuilt_templates SET name=%s, template=%s, css=%s, js=%s WHERE tid=%s",
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['template'], "text"),
                       GetSQLValueString($_POST['css'], "text"),
                       GetSQLValueString($_POST['js'], "text"),
...
if ((isset($_GET['did'])) && ($_GET['did'] != "")) {
  $deleteSQL = sprintf("DELETE FROM prebuilt_templates WHERE tid=%s",
...
mysql_select_db($database_conn, $conn);
$query_rsView = "SELECT tid, name FROM prebuilt_templates";
...
mysql_select_db($database_conn, $conn);
$query_rsEdit = sprintf("SELECT * FROM prebuilt_templates WHERE tid = %s", $colname_rsEdit);
